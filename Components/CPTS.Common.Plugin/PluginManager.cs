...
namespace CPTS.Common.Plugin
{
    ...
    public class PluginManager
    {
        ...
        private const string InstalledPluginsFilePath = "~/InstalledPlugins.txt";
        ...
        public static void Initialize()
        {
            ...
            if (!ConfigurationManager.AppSettings["IsLoadingPlugins"].ParseType<bool>()) return;
            ...
            using (new WriteLockDisposable(Locker))
            {
                ...
                try
                {
                    ...
                    foreach (var dfd in GetDescriptionFilesAndDescriptors(pluginFolder))
                    {
                        ...
                        //依附主版本问题暂时不支持
                        if (!pluginDescriptor.SupportedVersions.Contains(PayWindowVersion.CurrentVersion, StringComparer.InvariantCultureIgnoreCase))
                        {
        ...
        private static bool IsPackagePluginFolder(DirectoryInfo folder)
        {
            ...
            if (folder.Parent == null || folder.Parent.Parent == null) return false;
            if (!folder.Parent.Parent.Name.Equals("Plugins", StringComparison.InvariantCultureIgnoreCase)) return false;
            return true;
        }
