...
using CPTS.Common.Remoting.Exceptions;
using CPTS.Common.Scheduling;
using CPTS.Common.Socketing;
using CPTS.Common.Socketing.BufferManagement;
...
namespace CPTS.Common.Remoting
{
    public class SocketRemotingClient
    {
        ...
        public SocketRemotingClient(EndPoint serverEndPoint, SocketSetting setting = null, EndPoint localEndPoint = null)
        {
            ...
            _scheduleService = CPTS.Common.EngineCommon.ScheduleService;
            ...
            foreach (var key in timeoutKeyList)
            {
                ...
                if (_responseFutureDict.TryRemove(key, out responseFuture))
                {
                    ...
                    responseFuture.SetResponse(new RemotingResponse(
                        ...
                        request.Header,
                        null));
                    _logger.Debug("Removed timeout request:{0}", responseFuture.Request);
                }
            }
        }
